...
const Pantai = ({onDetail, dataUser}) => {
  ...
  return (
    ...
    <div className='mb-16 mt-6'>
      <Typography style={{fontWeight: 'bold', display: 'flex', flexDirection: 'column'}} variant='h3'>Kategori <span>Pantai</span></Typography>
      <Typography variant='subtitle1'>Coba jelajahi destinasi dengan kategori Pantai</Typography>
    </div>
    <div className='grid bg-gray-100 sm:grid-cols-2 gap-12 md:grid-cols-3 lg:grid-cols-4'>
    {data.map( datas=> (
      <>
      {
        datas.kategori_id == "6294d59de57bf79a3c2982e1" && (
